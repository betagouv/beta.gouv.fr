...
html-proofer:
	bundle exec htmlproofer ./_site/ --ignore-files "/recrutement\/*/"  --ignore-files "/api\/swagger\.html" --no-enforce-https --disable-external --root_dir _site/ --allow-missing-href
