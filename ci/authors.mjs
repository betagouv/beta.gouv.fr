...
export const schema = z.object({
  ...
  missions: z.array(
    z.object({
      ...
      startups: z.array(z.enum(startupsIds)).optional().superRefine(preventDuplicates),
    })
  ),
  previously: z.array(z.enum(startupsIds)).optional().nullable().superRefine(preventDuplicates),
  startups: z.array(z.enum(startupsIds)).optional().nullable().superRefine(preventDuplicates),
