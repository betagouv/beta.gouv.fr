...
![La densité de population détermine la fréquence d'usage.]({{ site.baseurl }}img/posts/2017-04-13-mes-aides-datascience-public/repartition-usage-villes.jpg)
...
![La richesse semble influer sur l'usage en Île-de-France, à l'exception de Versailles.]({{ site.baseurl }}img/posts/2017-04-13-mes-aides-datascience-public/repartition-usage-idf.jpg)
...
![Types de logements simulés : 55% de locataires, 30% de propriétaires, 12% de personnes hébergées, 3% sans domicile.]({{ site.baseurl }}img/posts/2017-04-13-mes-aides-datascience-public/repartition-logement.png)
...
![Sélection du logement : locataire, propriétaire, hébergé (incluant gratuit), sans domicile.]({{ site.baseurl }}img/posts/2017-04-13-mes-aides-datascience-public/selection-type-logement.png)


### Ressources

La grande majorité des visiteurs perçoit des salaires, ou un _revenu de remplacement_ du salaire : chômage ou retraite. Ensuite seulement apparaissent les allocations (logement, familiales…), puis d'[autres ressources]({{ site.baseurl }}img/posts/2017-04-13-mes-aides-datascience-public/ressources-sans-top-2.png).

![Les cinq ressources les plus souvent déclarées : salaire, chômage, retraite, allocation logement, allocations familiales.]({{ site.baseurl }}img/posts/2017-04-13-mes-aides-datascience-public/top-5-ressources.png)
...
![Répartition des sommes des revenus]({{ site.baseurl }}img/posts/2017-04-13-mes-aides-datascience-public/ressources.png)
...
![Répartition temporelle des simulations]({{ site.baseurl }}img/posts/2017-04-13-mes-aides-datascience-public/frequentation-backend.png)
![Répartition temporelle des visites]({{ site.baseurl }}img/posts/2017-04-13-mes-aides-datascience-public/frequentation-piwik.png)
