...
## À propos de la phase d'investigation 
...
A la fin de cet accompagnement de 9 semaines, une synthèse est produite et contient :
- une compréhension claire du problème : qui est concerné ? combien de personnes sont touchées ? quel est le préjudice qu’elles subissent ? ;
- une compréhension documentée des besoins des personnes concernées par le problème ;
- une visibilité sur les solutions qui existent déjà ; 
- une liste d’hypothèses de solution à tester sur un périmètre réduit pendant une première phase de développement de solution, éventuellement agrémentée de maquettes ; 
