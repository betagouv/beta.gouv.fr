...
> - **construire** des services publics nouveaux dans des domaines où la puissance publique n’était pas encore présente : [Pix](https://beta.gouv.fr/startups/pix.html), [transport.data.gouv.fr](http://transport.data.gouv.fr/), [le registre de preuve de covoiturage](https://beta.gouv.fr/startups/preuve-de-covoiturage.html)
