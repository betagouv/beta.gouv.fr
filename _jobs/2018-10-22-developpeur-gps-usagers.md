...
L’équipe GPS usagers cherche un·e développeur·euse web full stack afin de développer « from scratch » un produit permettant d’orienter l’usager vers le bon interlocuteur et de lui proposer le bon moyen de communication (mail, téléphone, prise de rendez-vous, demande de rappel dès que possible, chat, etc.).

## Votre profil

- Vous avez toutes les compétences et au moins une expérience dans la construction d’un produit from scratch : conception orientée utilisateur, back, front, déploiement, outils de suivi, etc.
