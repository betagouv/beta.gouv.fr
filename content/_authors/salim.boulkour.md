...
role: Ops / DevOps # Développeu·r·se / Intrapreneu·r·se / Coach / Chargé de développement / ...
...
github: sboulkour # optionnel : nom d'utilisateur GitHub, permet d'être ajouté automatiquement à l'organisation GitHub betagouv
start: 2019-01-01 # date d'arrivée au format ISO (AAAA-MM-JJ)
end: 2019-06-30 # date de fin de contrat au format ISO (AAAA-MM-JJ)
employer: service/octo# dinsic ou independent/<employer> ou admin/<employer> ou service/octo
...
Ancien FranceConnect, actuellement à l'incubateur des ministères sociaux.
