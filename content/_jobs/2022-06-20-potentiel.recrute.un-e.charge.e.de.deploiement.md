...
[Potentiel](https://potentiel.beta.gouv.fr/) est une Startup d’État, accompagnée par l'incubateur du Ministère de la Transition énergétique, La Fabrique Numérique.
...
Vous aurez pour mission de contribuer au développement stratégique et opérationnel du produit. L'un des objectifs phares étant de tendre vers 100% de porteurs de projets soutenus par l'Etat inscrits sur Potentiel 🌟

### Marketing

* Participer aux orientations stratégiques sur le produit, sur la proposition de valeur et la définition des objectifs ;  
* S'approprier le fonctionnement de Potentiel afin d'en assurer les démonstrations, présentations, etc. ;
* Mettre en oeuvre et approfondir la stratégie marketing et communication afin de soutenir l'activation et la rétention des utilisateurs (newsletters, synthèse d'enquêtes, conception de flyers, webinaires de présentation...) ;
...
* Mettre à jour et diffuser la documentation produit, comme support d'aide pour nos utilisateurs ;

Cette liste n’est pas exhaustive et sera amenée à évoluer - dans le même domaine de compétences - en fonction des besoins de la startup et de votre profil.

## Profil recherché

Expérience professionnelle sur une mission similaire (B to B), de type Business Development ou Chargé·e de marketing, ou première expérience suite à l’obtention d’un diplôme d’une grande école ou école de commerce.
...
* Vous aimez travailler dans une petite équipe (6 personnes à ce jour), de manière agile avec de fortes responsabilités ;
...
* Idéalement, vous êtes familier·ère avec la production de données statistiques ;
* Idéalement, vous êtes familier·ère avec les concepts et la mise en place de tunnel d’acquisition (funnel A-AARRR) ou tout autre moyen de suivre, rationaliser et mesurer l’impact des actions de déploiement (appétence pour la donnée).

Idéalement vous avez de l’expérience dans un ou plusieurs des domaines suivants :

* Le marketing et la communication
* Les relations usagers et partenaires
* La promotion et / ou le déploiement de services numériques (applications, sites web, API, etc.)

## Informations pratiques

Date d’entrée souhaitée : début juillet 2022 ou début septembre 2022 (à négocier)

Type de contrat : mission freelance de 6 mois renouvelable à 3 jours par semaine 

Modalités : le télétravail est la norme, des locaux sont cependant disponibles à la Défense et des sessions de travail co-localisées ponctuelles pourront être mises en place.

## Comment postuler ?

Expliquez-nous pourquoi vous avez envie de rejoindre la Startup Potentiel et envoyez-nous votre CV, des réalisations si elles vous semblent pertinentes et votre TJM à team@potentiel.beta.gouv.fr, accompagné, le cas échéant d’un lien vers votre profil LinkedIn.
