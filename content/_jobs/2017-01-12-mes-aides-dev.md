...
- Mise à jour de **Node** à la v6 depuis 0.10 ([`betagouv/mes-aides-api#37`](https://github.com/betagouv/mes-aides-api/issues/37)).
- Intégration d'une [nouvelle version](https://github.com/betagouv/ludwig/) de [l'interface de tests fonctionnels](https://mes-aides.gouv.fr/tests/) qui permet l'amélioration du produit par des utilisateurs non techniques (**JS, Git**).
- Ajout du calcul de l'éligibilité à un logement social ([`#431`](https://github.com/betagouv/mes-aides-ui/issues/431)) (**Angular, JS, Python**).
...
Comme pour tous les postes de l'incubateur, il s'agit aussi d'une opportunité de [co-construire `beta.gouv.fr`](https://github.com/betagouv/beta.gouv.fr/wiki) avec [plein de gens bien](https://beta.gouv.fr/communaute) et de participer ainsi à la transformation numérique de l'administration française 🤘
...
- Télétravail partiel bienvenu, avec 1 à 2 jours par semaine [à Paris](https://github.com/betagouv/beta.gouv.fr/wiki/Locaux) pour bien construire l'équipe.
