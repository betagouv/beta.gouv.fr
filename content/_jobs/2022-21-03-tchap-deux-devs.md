...
## Mission
Au sein de l'équipe Tchap, nous recherchons 2 devs senior pour 2 missions principales différentes : Tchap Web et Tchap Identité.
Vous pourrez aussi être amené à travailler de manière occasionnel au produit AudioConf, à son intégration dans Tchap.

L'équipe intégre déjà 2 devs web, 5 devops qui s'occupe de l'infra et du backend de Tchap et 4 devs mobile.
L'équipe web sera composé de 4 personnes après l'intégration de 2 personnes suites à la publication de l'offre.
Le mode d'organisation se décide en équipe et peut évoluer en fonction des retours des retrospectives.

### Missions Principale : Tchap Web
C'est la version du client Web de Tchap basé sur le logiciel OpenSource Element Web :
https://github.com/vector-im/element-web
Le backend utilisé est https://github.com/matrix-org/synapse basé le protocole ouvert matrix : https://matrix.org , il n'y a normalement pas de modification à entreprendre sur le backend.
...
### Mission Principale Alternative  : Tchap Identité
C'est une nouvelle application permettant d'utiliser Tchap comme fournisseur d'identité pour les agents de l'état pour leur permettre de se connecter à d'autres services de l'état.

Le langage n'est pas encore déterminé, ça serait :
- soit du Python/Django si on reprends le code d'Aidant Connect : https://github.com/betagouv/Aidants_Connect (Fournisseur d'identité pour les aidants accompagnant des personnes en difficulté avec le numérique)
...
Code source : https://github.com/betagouv/conferences
...
- Connaître l’utilisation des technologies utilisés aux seins de Tchap ;
...
- Temps de travail de 4 ou 5 par semaine et télétravail partiel ou total possible ; (Démarrage possible à mi-temps si convergence vers 
...
Précisez si vous avez de l'appétence pour Tchap Web, Tchap ID ou pour les 2. 
