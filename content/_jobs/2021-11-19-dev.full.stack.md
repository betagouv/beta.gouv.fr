...
* Bonne expérience dans l'une des technologies serveur les plus utilisées chez beta.gouv ( Javascript (Node) ou Python (Django) )
* Prêt à faire de la mise en production avec un PaaS
