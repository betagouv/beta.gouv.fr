---
roles: Une ou un dev front pour Reva
open: true
...
domaines:
  - Développement
---
# REVA recrute une ou un dev front
...
* Vous êtes un.e développeur.se front-end ou full-stack confirmé.e (au moins 5 années d'expérience professionnelle)
* Vous avez une bonne expérience en Typescript et React
* Vous connaissez ou avez envie d'apprendre XState
* Vous êtes prêt à tester l'application mobile sous Android Studio ou XCode (celle-ci est développée avec React et Capacitor)
...
* Temps de travail : 5 jours / semaine ou temps partiel éventuellement
...
Envoyez votre CV, ou votre profil LinkedIn par mail à [nathaniel.richand@beta.gouv.fr](mailto:nathaniel.richand@beta.gouv.fr) et [cedric.soulas@beta.gouv.fr](mailto:cedric.soulas@beta.gouv.fr)
