...
Comme notre solution a prouvé son intérêt, nous sommes actuellement en train d'accélérer son déploiement dans la France entière.

Ta mission sera d’accompagner l’équipe dans le développement de ces interfaces ainsi que dans leur déploiement à d'autres juridictions et la réalisation d'autres fonctionnalités. A terme, ta mission sera également de préparer la transmission de nos outils au ministère de la Justice en respectant les contraintes techniques de l'administration.
...
L’exploration : « Vite un prototype pour tester une hypothèse avec des utilisateurs dès demain ! » L’exploitation : « Il est temps de refactorer et de mettre du monitoring sur ce module ! »
...
Nos repo Github sont accessibles ici et [ici](https://github.com/betagouv/mon-suivi-justice-public).
...
Poste ouvert pour le statut d’indépendant 4 jours par semaine
...
Damin Le Thiec : damien.le-thiec@beta.gouv.fr