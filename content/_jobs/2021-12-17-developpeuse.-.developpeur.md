...
## La mission : création de la plateforme 

En tant que co-associé.e en charge du développement, tes missions seront, en binôme avec une développeuse ayant conçu un produit équivalent « PsyEnfantAdo » et en lien avec la cheffe de projet, de :
•	Créer une plateforme à destination du grand public, des psychologues et des professionnels de santé
•	S’assurer que la plateforme réponde aux exigences de conformité (« marque Etat ») , de sécurité (RGPD) et d’accessibilité indispensables aux sites gouvernementaux 
•	Création d’un annuaire grand public avec géolocalisation
•	Maintenir en usage la plateforme et l’adapter aux nouveaux besoins
•	Mettre en ligne au fil de l’eau les nouveaux contenus
•	Participer à l’élaboration de solutions rapides
Le développeur ou la développeuse sera au cœur de cette aventure à impact national.

## Contexte technique 

•	JavaScript, TypeScript, React
•	Applications accessibles (RGAA)
•	PostgreSQL
•	Docker
•	Intégration/déploiement continus
•	Méthodologie de tests unitaires et end-to-end
•	Notions de sécurité des applications webs
...
•	Temps de travail : 2 jours / semaine en moyenne (avec une marge plus importante en janvier / février 2022)
