...
Potentiel a été créé début 2020, depuis début 2022, nous avons enclanché progressivement l'amélioraton de l'UX et de l'UI de l'app. Nous souhaitons renforcer l'équipe afin d'aller au bout de ce chantier, ainsi que bien d'autres encore ! Par exemple, nous avons lancé récemment une enquête auprès du persona DREAL (Direction Générale de l'Aménagement et du Logement, qui intervient sur Potentiel). Sur la base de leurs retours, nous enclanchons l'amélioration de leur parcours sur l'app.
...
* Participer à l'amélioration UX et UI du produit
* * UX : participer au travail de user research afin de comprendre les usages produit, les parcours et in fine améliorer l’UX produit
  * UI : être garant·e de l’implémentation des changements et force de proposition et de recommandation sur ceux-ci
...
* Vous aimez travailler dans une petite équipe (6 personnes à ce jour), de manière agile, selon les principes du lean startup et avec de fortes responsabilités ;
...
* L'implémentation d'améliorations UX/UI de manière générale
* Les technologies mentionnées supra (React, Typescript, NodeJS)

## Informations pratiques

Les entretiens se tiendront dans le courant du mois de mai.
...
Modalités : le télétravail est la norme, des locaux peuvent cependant être mis à disposition à la Défense et des sessions de travail co-localisées ponctuelles pourront être mises en place.
