---
 ...
 techno: selon les produits (cf annonce) 
 open: true
...
Ne te censures pas si :
Tu ne coches pas toutes les cases ci-dessus, mais que tu as envie d’apprendre et de progresser ;
Tu ne connais pas très bien l'écosystème de l’administration. 

## Les détails à connaître : 

### Contrat
Poste ouvert pour un CDD à temps plein, en contrat de vacataire, d’une durée de 6 mois, si tu te poses la question, nous sommes presque tous contractuels ou indépendants au sein de la communauté beta.gouv.fr.
Rémunération
...
### Travail à distance
Le travail à distance est possible, ponctuellement, sans qu’un préavis ou une validation ne soient nécessaires — sois simplement raisonnable. Pour contribuer aux rituels d’équipes et discuter avec les autres membres de beta.gouv.fr, les équipes se croisent à leur rythme parfois un jour par semaine, parfois un jour tous les 15 jours au vu des conditions sanitaires actuelles.  
...
Une fois la décision de l'équipe prise, c'est la Direction des services administratifs et financiers des services du Premier Ministre qui prend le relai pour constituer le dossier administratif. Le délai de recrutement prend en moyenne 4 semaines. 
...
Si tu as des questions avant de postuler, n'hésitez pas à les poser à la même adresse.
...
Si vous tu souhaites mieux comprendre nos sujets, la ressource la plus pertinente à notre avis reste notre site web : https://beta.gouv.fr mais aussi notre github : https://github.com/betagouv/beta.gouv.fr 
