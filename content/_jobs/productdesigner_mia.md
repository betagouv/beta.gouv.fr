...
Vous serez intégré à l’équipe du produit “La Bonne Alternance” composée d’un Product Manager, de deux Product owners, et de trois développeurs. 

Nous recherchons un.e product designer pour :
* Améliorer les fonctionnalités existantes et concevoir les futures évolutions ;
* Spécifier et suivre la mise en production avec les développeurs ;
* Participer à la recherche utilisateur : vous appréciez mener des interviews ou des tests utilisateurs.
...
* Expérience souhaitée de 4 à 5 ans minimum ;
