...
Une **boîte à outils évolutive** constituée d’outils préexistants, adaptés ou développés par nos soins répondant aux besoins en manipulations de données des collectivités et de l’ANCT.

**Un guichet données** : une équipe dédiée, à l’écoute des besoins et pilotant la mise en place de la boîte à outils. Sollicitez-le si vous avez un besoin non-couvert par la boîte à outils. [Nous contacter]
...
La manipulation de données se fait souvent aujourd’hui de façon isolée (fichiers Excel sur le poste d’un agent), ayant pour conséquence une grande perte de temps dans le traitement de ces données : fichiers non normalisés donc beaucoup d’erreurs, difficile à partager, à mettre à jour, etc.
