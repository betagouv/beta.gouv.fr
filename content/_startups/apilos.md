...
* *Investigation et recherche d’impact auprès de nouveaux partenaires (CAF, SPF…)* 
...
* Fin mars - *Couvrir l'ensemble des fonctionnalités requises pour à 100 % des besoins de conventionnement* (ex : convention HLM, foyers résidences...)
...
* *Depuis sa mise en ligne 9 400 logements ont été réalisés via la plateforme APiLos.* (A titre de comparaison, en 2021, 75 000 logements ont été mis en service). Ainsi, APiLos serait en mesure de couvrir 10% du nouveau parc de logements sociaux.  
