---
title: Tremplin # une majuscule et pas d'acronymes
mission: Rapprocher les professionnels de santé de leur futur territoire d’exercice # infinitif, pas de point ; compléter la phrase « En investissant dans ce produit l'État cherche à… »
owner: le Ministère des Solidarités et de la Santé # Administration porteuse
incubator: l'incubateur des ministères sociaux # le nom du fichier de l'incubateur de la startup
status: construction # les phases possibles sont définies dans /content/_phases/
start: 2019-01-01 # date au format ISO (AAAA-MM-DD)
end: # laisser vide
link: 
