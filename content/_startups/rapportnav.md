...
Nous souhaitons refondre l'expérience utilisateur du Rapport Nav existant afin d'optimiser son usage par les unités terrain, et ainsi la qualité des données saisies. L'engagement des bureaux de la DGAMPA dans l'analyse de ces données permettra d'améliorer les orientations et la coordination des actions des unités sur le terrain, et de maximiser leur impact auprès des citoyens. 
Les périmètres où nous souhaitons améliorer l’impact de l’action de l'État sont: 
* la pêche, 
* la protection de l’environnement marin, 
* les conditions de travail des gens de mer,
...
La 1ere version de Rapport Nav a suivi plusieurs objectifs : 
...
le cas échéant, 
* Améliorer la réglementation pour la rendre plus applicable
