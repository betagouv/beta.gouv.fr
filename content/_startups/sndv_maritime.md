...
phases:
  ...
  - name: acceleration
    start: 2022-09-20
stats_url: Non publique
analyse_risques_url: Non publique
...
La priorisation du déploiement a été guidé par deux facteurs : la qualité de la donnée collecté sur le port x le volume d'escale sur le port
