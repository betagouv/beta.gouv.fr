...
L’entrée en apprentissage est un levier clé de la politique prioritaire du plein emploi, car c’est une voie de formation très insérante, mais :

* F﻿ace à l'objectif de +1M d'apprentis chaque année, la barrière des 860 000 nouveaux contrats annuels semble difficile à franchir.
* La progression du nombre de contrats d’apprentissage **dans le secondaire est 2 fois moins importante** que dans le supérieur (entre 2019 et 2023). Cela s’explique notamment par la concentration de préjugés associés à cette voie d’orientation.
* ~1 500 CFA se sont créés depuis la loi de 2018, rendant peu lisibles les formations proposées aux jeunes et la qualité perçue des formations existantes.

Aujourd’hui de nombreuses informations, notamment quantitatives existent pour présenter la voie de l’apprentissage, mais pour faire leurs choix, les candidats à l’apprentissage recherchent des retours d’expérience et des témoignages pour comprendre la réalité de cette voie d’orientation.

L’accès à ces témoignages n’est pas aisé pour les candidats et ceux qui les accompagnent. Aujourd’hui aucune source neutre n’expose des avis vérifiés sur la qualité perçue des formations en apprentissage.

- - -

# Sirius

Le produit bénéficie d’un appui interministériel :
...
Sirius donne accès aux témoignages des apprentis pour aider les jeunes dans leurs choix d’orientation et propose une solution en deux volets :
