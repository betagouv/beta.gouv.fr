...
Covoiturage.beta.gouv accompagne et amplifie le déploiement des politiques publiques locales ou nationales en faveur du covoiturage quotidien.
Autour d'un registre de preuve agrégeant la quasi totalité des trajets normalisés et qualifiés provenant des plateformes de covoiturage quotidien intermédié, des services connexes sont déployés pour : sensibiliser l'écosystème aux différentes politiques publiques à travers des webinaires et un observatoire national ; renforcer les liens de confiance entre acteurs publics et privés en accompagnant la lutte contre la fraude ; et en facilitant la mise en place des dispositifs d'aide au développement de la pratique : campagnes d'incitations financières, forfait mobilité durable, fond vert et prime CEE (ce dernier dispositif à pris fin le 31 janvier 2015).

## L’impact

* L'indicateur principale de valeur de la SE est le volume de covoiturages du quotidien traités et enregistrés comme valides dans notre registre de preuve de covoiturage car il est simple à suivre. Nous visions 1 million de trajets mensuel à fin 2023. Si l'objectif a été atteint en 2024 avec l'attrait des CEE, cette tendance à la hausse s'est confirmée en 2025 (hors période estivale) après l'arrêt des CEE en 2025. 
* Comme indicateurs d'impact, nous apprécions la nécessité de ces données auprès des collectivités dans la planification et les mesures de résultat des politiques en faveur du covoiturage sur leur territoire.
* Nous mesurons également l'efficience de notre service avec un coût au trajet validés
*  Enfin des indicateurs secondaires permettent de mesurer pour chacun des   services rendus leur usage et utilité

. [Voir tous ces indicateurs sur la page de statistiques d'impact de covoiturage.beta.gouv](https://stats.covoiturage.beta.gouv.fr/public/dashboard/2084d346-8e3b-495e-9b10-b4870a35632a)
