...
**La captation des données professionnelles par les plateformes renforce le risque de déréglementation.  
Le transport routier peut ainsi subir une transformation numérique du seul fait des GAFAM, qui, comme ils l’ont fait dans d’autres secteurs, imposeront leurs règles et orientations avec des impacts économiques, sociaux et environnementaux non maîtrisés** (on reconnait là le *phénomène d’uberisation*).
