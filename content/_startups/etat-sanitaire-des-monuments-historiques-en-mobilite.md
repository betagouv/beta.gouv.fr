...
La France compte environ 45 000 monuments historiques qui doivent être régulièrement vérifiés pour garantir leur préservation. Cela est fait par des experts de l'Etat dans le cadre du contrôle scientifique et technique. Lors de cette mission des constats d'état sont dressés lors de visite, avec une couverture photographique. Ce constat rend compte de l'état apparent du bien protégé, sans mise en œuvre d'aucune technologie. Outre l’établissement de l’état de conservation, cette visite permet d’identifier et de prévenir les risques. Les données sont enregistrées dans les applications du ministère de la Culture afin de réaliser les synthèses territoriales et la comparaison dans le temps et de mettre à jour les données existantes et, le cas échéant, la protection juridique. Aujourd'hui, ces comptes-rendus doivent être enregistrés dans le logiciel Agrégée afin qu'ils soient stockés au niveau national.

## Problème
Malheureusement, aujourd'hui, les pratiques sont différentes de ce qui est attendu :
...
- La fiabilité des données renseignées lors des bilans quinquennaux pose question.
...
Objectif d'impact à 6 mois (juin 2025) :
